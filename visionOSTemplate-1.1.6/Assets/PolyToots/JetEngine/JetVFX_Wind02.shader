...
Shader "PolyToots/JetEngine"
{
	Properties
	{
		...
		[HDR]_Colour("Colour", Color) = (1,0.5299013,0,0)
		_EngineOffOn("Engine Off/On", Range( 0 , 1)) = 1
		_Thrust("Thrust", Range( 0 , 1)) = 0.5
		_JiggleStrength("Jiggle Strength", Float) = 4
		[Toggle]_DisableJiggle("Disable Jiggle", Float) = 1
		_NoiseScale("Noise Scale", Range( 0 , 20)) = 1.692326
		_NoiseSpeed("Noise Speed", Range( 0 , 40)) = 2
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord17 = v.ase_texcoord.xy * float2( 1,3.6 ) + ( _TimeParameters.x * float2( 0,1 ) );
				float Thrust136 = _Thrust;
				float3 VertOffset167 = ( ( frac( ( texCoord17.y * 2.0 ) ) * (( _DisableJiggle )?( 0.0 ):( ( _JiggleStrength * Thrust136 ) )) ) * v.normalOS );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord1 = IN.ase_texcoord3.xy * float2( 0,1.06 ) + float2( 0,0 );
				float Thrust136 = _Thrust;
				...
				float2 texCoord38 = IN.ase_texcoord3.xy * ( float2( 1,0.2 ) * _NoiseScale ) + ( _TimeParameters.x * ( float2( 0,-0.5 ) * ( Thrust136 * _NoiseSpeed ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float Thrust136 = _Thrust;
				float2 texCoord38 = IN.ase_texcoord2.xy * ( float2( 1,0.2 ) * _NoiseScale ) + ( _TimeParameters.x * ( float2( 0,-0.5 ) * ( Thrust136 * _NoiseSpeed ) ) );
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord2.xy * float2( 0,1.06 ) + float2( 0,0 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float Thrust136 = _Thrust;
				float2 texCoord38 = IN.ase_texcoord.xy * ( float2( 1,0.2 ) * _NoiseScale ) + ( _TimeParameters.x * ( float2( 0,-0.5 ) * ( Thrust136 * _NoiseSpeed ) ) );
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord.xy * float2( 0,1.06 ) + float2( 0,0 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
				

				surfaceDescription.Alpha = Alpha164;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float Thrust136 = _Thrust;
				float2 texCoord38 = IN.ase_texcoord1.xy * ( float2( 1,0.2 ) * _NoiseScale ) + ( _TimeParameters.x * ( float2( 0,-0.5 ) * ( Thrust136 * _NoiseSpeed ) ) );
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord1.xy * float2( 0,1.06 ) + float2( 0,0 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-3065.281,-798.8955;Inherit;False;Property;_Thrust;Thrust;2;0;Create;True;0;0;0;False;0;False;0.5;0.484;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-3318.746,-1080.175;Inherit;False;Property;_NoiseSpeed;Noise Speed;6;0;Create;True;0;0;0;False;0;False;2;10;0;40;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;36;-2932.291,-1291.896;Inherit;False;Constant;_ScrollDirection;Scroll Direction;0;0;Create;True;0;0;0;False;0;False;0,-0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;1;-2633.669,-846.2125;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0,1.06;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;141;-2733.277,-1727.61;Inherit;False;Constant;_Vector2;Vector 2;6;0;Create;True;0;0;0;False;0;False;1,0.2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-2828.365,-1565.1;Inherit;False;Property;_NoiseScale;Noise Scale;5;0;Create;True;0;0;0;False;0;False;1.692326;2;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;21;-2328.873,-75.70417;Inherit;False;Constant;_Vector0;Vector 0;0;0;Create;True;0;0;0;False;0;False;0,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;139;-2084.416,-1292.572;Inherit;True;Property;_MainTex;Noise Texture;7;0;Create;False;0;0;0;False;0;False;-1;4906295d398558a489618dd52730844d;4906295d398558a489618dd52730844d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;65;-1978.641,177.2584;Inherit;False;Property;_JiggleStrength;Jiggle Strength;3;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1996.89,23.41018;Float;False;Constant;_Pulses;Pulses;1;0;Create;True;0;0;0;False;0;False;2;0;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-1963.987,-148.7636;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,3.6;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;153;-1785.372,362.3311;Inherit;False;Constant;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;151;-1609.919,224.7207;Inherit;False;Property;_DisableJiggle;Disable Jiggle;4;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;89;-837.6276,-791.8212;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;96;-916.6707,-545.8555;Inherit;False;Property;_EngineOffOn;Engine Off/On;1;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;111;-1232.646,-1647.375;Inherit;False;Property;_Colour;Colour;0;1;[HDR];Create;True;0;0;0;False;0;False;1,0.5299013,0,0;0.02901835,0.07339936,0.07681328,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;117;-1155.975,-1411.241;Inherit;False;Constant;_Float1;Float 1;6;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=50402D641DA10B44C0DE43F1AC4E33641071AD36