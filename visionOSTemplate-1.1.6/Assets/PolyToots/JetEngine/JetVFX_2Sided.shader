	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord1 = IN.ase_texcoord3.xy * float2( 0,0.74 ) + float2( 0,0 );
				float Thrust136 = _Thrust;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord2.xy * float2( 0,0.74 ) + float2( 0,0 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float Thrust136 = _Thrust;
				float2 texCoord38 = IN.ase_texcoord.xy * ( float2( 1,0.2 ) * _NoiseScale ) + ( _TimeParameters.x * ( float2( -0.2,-0.3 ) * ( Thrust136 * _NoiseSpeed ) ) );
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord.xy * float2( 0,0.74 ) + float2( 0,0 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float Thrust136 = _Thrust;
				float2 texCoord38 = IN.ase_texcoord1.xy * ( float2( 1,0.2 ) * _NoiseScale ) + ( _TimeParameters.x * ( float2( -0.2,-0.3 ) * ( Thrust136 * _NoiseSpeed ) ) );
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord1.xy * float2( 0,0.74 ) + float2( 0,0 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-3065.281,-798.8955;Inherit;False;Property;_Thrust;Thrust;2;0;Create;True;0;0;0;False;0;False;0.5;0.44;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-3318.746,-1080.175;Inherit;False;Property;_NoiseSpeed;Noise Speed;6;0;Create;True;0;0;0;False;0;False;2;2;0;40;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;36;-2932.291,-1291.896;Inherit;False;Constant;_ScrollDirection;Scroll Direction;0;0;Create;True;0;0;0;False;0;False;-0.2,-0.3;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;40;-2828.365,-1565.1;Inherit;False;Property;_NoiseScale;Noise Scale;5;0;Create;True;0;0;0;False;0;False;1.692326;5;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;1;-2533.669,-846.2125;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0,0.74;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;21;-2328.873,-75.70417;Inherit;False;Constant;_Vector0;Vector 0;0;0;Create;True;0;0;0;False;0;False;0,-2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-916.6707,-545.8555;Inherit;False;Property;_EngineOffOn;Engine Off/On;1;0;Create;True;0;0;0;False;0;False;1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;111;-1232.646,-1647.375;Inherit;False;Property;_Colour;Colour;0;1;[HDR];Create;True;0;0;0;False;0;False;1,0.5299013,0,0;0.08793163,0.1829366,0.1886792,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=942AFE1D120BC8D20F7ED682821890EE1683966B