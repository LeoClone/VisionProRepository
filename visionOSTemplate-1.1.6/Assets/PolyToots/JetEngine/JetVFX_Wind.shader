	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord17 = v.ase_texcoord.xy * float2( 0,0 ) + ( _TimeParameters.x * float2( 0,1 ) );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord1 = IN.ase_texcoord3.xy * float2( 0,-1.06 ) + float2( 0,1 );
				float Thrust136 = _Thrust;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord2.xy * float2( 0,-1.06 ) + float2( 0,1 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord.xy * float2( 0,-1.06 ) + float2( 0,1 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float _scroll161 = tex2D( _MainTex, texCoord38 ).a;
				float2 texCoord1 = IN.ase_texcoord1.xy * float2( 0,-1.06 ) + float2( 0,1 );
				float _gradient159 = ( -( texCoord1.y - Thrust136 ) * 2.0 );
				float Alpha164 = saturate( ( ( _scroll161 + _gradient159 ) * _EngineOffOn ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-3065.281,-798.8955;Inherit;False;Property;_Thrust;Thrust;2;0;Create;True;0;0;0;False;0;False;0.5;0.527;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-3318.746,-1080.175;Inherit;False;Property;_NoiseSpeed;Noise Speed;6;0;Create;True;0;0;0;False;0;False;2;4;0;40;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;1;-2633.669,-846.2125;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0,-1.06;False;1;FLOAT2;0,1;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-2828.365,-1565.1;Inherit;False;Property;_NoiseScale;Noise Scale;5;0;Create;True;0;0;0;False;0;False;1.692326;2.03;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-1963.987,-148.7636;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=9A7A002B4645B51B5F205085984A1634F1136C49